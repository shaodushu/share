...
export default class Index extends Component<{}, State>  {
  ...
  render() {
    const { shareImage, painting } = this.state
    return (
      <View className='index'>
        <Image src={shareImage} class="share-image" />
        <CanvasDrawer painting={painting} getImage={this.getImage} />
        <Button onClick={this.drawImage}>绘制</Button>
